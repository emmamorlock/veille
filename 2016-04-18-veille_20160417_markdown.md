...
**Projets européens** - Traduction française de 2 guides pour Horizon 2020 - 1 : libre accès aux publications scientifiques et aux données de la recherche ; 2 : lignes directrices concernant la gestion des données et lélaboration dun plan de gestion de ces données - via Libre accès à linformation scientifique et technique - 
